...
const TestimonialArea = () => {  
    ...
    const setting = {
        ...
        autoplay: {
            ...
            disableOnInteraction: false, // Keep autoplaying even when user interacts with the slider
        },
    };
                    ...
                    <div className="row" >
                        <div className="col-lg-12">
                            <div className="tp-testimonial-title-wrapper text-center">
                                ...
                                <h3 className="tp-section-title">Professional <span className="title-color">Testimonial</span>
                                            ...
                                            <div className="tp-testimonial-item-inner">
                                                ...
                                                <div className="tp-testimonial-rating d-flex justify-content-center">
                                                    <span>
                                                        ...
                                                        {item.rating % 1 !== 0 && <i className="fa-solid fa-star-half"></i>}
                                                    </span>
                                                </div>
                                            </div>
                                            <div className="tp-testimonial-user-thumb">
                                                <Image src={item.avatar} alt="theme-pure" height={70} width={70} />
                                            </div>
