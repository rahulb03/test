...
const slider_data = [
  {
    ...
    hero_title_1: "Your IT Partner for Success in a",
  ...
  },
  {
    ...
    sub_title_1: "best",
    sub_title_2: "it solutions",
    hero_title_1: "Empowering Businesses through",
    hero_title_2: "Innovative IT",
  ...
  },
  {
    ...
    hero_title_2: "Maximum",
    hero_support: "Efficiency",    
  },
];
// shapes 
const shapes = [ 
...
const HeroSlider = () => {
  ...
  return (
    <>
      {/* <section className="tp-hero-area tp-hero-space pb-15"> */}
      <section className="tp-hero-area tp-hero-space ">
        <div className="tp-hero-wrapper p-relative"> 
                          ...
                          <div className="col-lg-9">
                            <div className="tp-hero-content p-relative">
                              <div className="tp-hero-title-wrapper">
                                <span className="tp-section-title__pre p-relative d-none">
                                  {item.sub_title_1}{" "}
                                ...
                                <div className="tp-hero-btn d-none">
          ...
          <div className="tp-hero-bottom d-none">
          ...
          >
            ...
            <p>
            Delivering tailored IT solutions that drive innovation, efficiency, and success for businesses in the digital era.
