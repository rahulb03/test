...
const slider_text = [
    <React.Fragment key={0}>Denouncing <span>pleasure</span> and praising pain was <br /> born and I will give you a complete account <br /> of the system, and expound the actual  <br /> teachings of the great explorer of truth the <br /> master builder</React.Fragment>,
    <React.Fragment key={1}>Ennings appetite disposed me an at <span>subjects</span> an. To no indulgence diminution so discovered mr apartments. Are off under folly death wrote cause her way spite. Plan upon yet way get cold spot its week.</React.Fragment>,
    <React.Fragment key={2}>Maximum consultation discover <span>apartments</span>. ndulgence off under folly death wrote cause her way spite. Plan upon yet way get cold spot its week. Almost do am or limits hearts.</React.Fragment>,
    <React.Fragment key={3}>The system, and expound the <span>actual Denouncing</span> pleasure and praising pain was born and I will give you a complete account of teachings of the great explorer of truth the master builder</React.Fragment>,
];
                        ...
                        <div className="tp-testimonial-3-wrapper">
                            <div className="tp-testimonial-3-wrapper-thumb p-relative">
                                ...
                                >
                                    {slider_img.map((item, i) =>
                                        <SplideSlide key={i}>
                                            <Image className="slide" src={item} alt={`Slider Image ${i + 1}`} />
                                        </SplideSlide>
                                    )}
                                </Splide>
                                <Image className="shape-1" src={testimonial_img_1} alt="theme-pure" />
